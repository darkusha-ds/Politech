...
lessons_first = load_json('data/jsons/lessons_1.json')
lessons_first = load_json('data/jsons/lessons_2.json')
lessons_first = load_json('data/jsons/lessons_3.json')
lessons_second = load_json('data/jsons/lessons_4.json')
